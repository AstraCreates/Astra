...
def get_orchestrator() -> Orchestrator:
    ...
    if _orchestrator is None:
        ...
        specialists = {
            ...
            "legal_docs": build_legal_docs_agent(use_computer=True, max_iterations=20, **_highoutput_kwargs),
            "legal_entity": build_legal_entity_agent(use_computer=True, max_iterations=20, **_highoutput_kwargs),
            "legal_ip": build_legal_ip_agent(use_computer=True, max_iterations=20, **_highoutput_kwargs),
            "marketing_content": build_marketing_content_agent(use_computer=True, max_iterations=20, **_highoutput_kwargs),
            "marketing_outreach": build_marketing_outreach_agent(use_computer=True, max_iterations=15, **_highoutput_kwargs),
            "marketing_seo": build_marketing_seo_agent(use_computer=True, max_iterations=20, max_tool_calls={"search_and_fetch": 3, "web_search": 5}, **_highoutput_kwargs),
            "marketing_paid": build_marketing_paid_agent(use_computer=True, max_iterations=20, max_tool_calls={"search_and_fetch": 4, "web_search": 6}, **_highoutput_kwargs),
            "sales_pipeline": build_sales_pipeline_agent(use_computer=False, max_iterations=15, **_small_kwargs),
