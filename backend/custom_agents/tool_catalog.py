...
CATALOG: list[ToolSpec] = [
    ...
    ToolSpec("google_calendar_create_event", "Create Google Calendar event", "Create a calendar event directly with Workspace OAuth.", "ops", connector="google_calendar"),
    ToolSpec("google_calendar_list_events", "List Google Calendar events", "List upcoming calendar events directly with Workspace OAuth.", "ops", connector="google_calendar"),
    ...
    ToolSpec("google_sheets_update_range", "Update Google Sheet range", "Write a rectangular range directly with Workspace OAuth.", "data", connector="googlesheets"),
    ...
    ToolSpec("google_docs_append_text", "Append to Google Doc", "Append text to a Google Doc directly with Workspace OAuth.", "data", connector="googledocs"),
    ToolSpec("google_docs_read_document", "Read Google Doc", "Read a Google Doc directly with Workspace OAuth.", "data", connector="googledocs"),
    ...
    ToolSpec("google_slides_add_slide", "Add slide to Google Slides", "Add a slide with title/body content directly with Workspace OAuth.", "data", connector="googleslides"),
    ToolSpec("google_drive_list_files", "List Google Drive files", "Browse Drive files directly with Workspace OAuth.", "data", connector="googledrive"),
    ToolSpec("google_drive_read_file", "Read Google Drive file", "Read a Drive file or exported Google file directly with Workspace OAuth.", "data", connector="googledrive"),
    ToolSpec("google_drive_create_text_file", "Create Google Drive file", "Create a text file in Drive directly with Workspace OAuth.", "data", connector="googledrive"),
