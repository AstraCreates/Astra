...
def build_technical_agent(**kwargs) -> Agent:
    return Agent(
        ...
        role=(
            ...
            "the full product: add sign-up/auth, a dashboard, and the core product features — KEEP the existing "
            "landing page>, session_id=<SESSION>, context=<research notes>) — MANDATORY. It clones the existing "
