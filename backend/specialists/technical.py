...
def build_technical_agent(**kwargs) -> Agent:
    return Agent(
        ...
        role=(
            ...
            "1. obsidian_read(agent='technical', founder_id=<FOUNDER_ID>) — get research context. If no notes found, proceed immediately using goal/shared context — do NOT retry.\n"
            "2. github_create_repo(repo_name=<kebab-case-COMPANY_NAME>, description=<desc>) — create repo. If this fails (no token/403), skip and continue with a placeholder repo_url.\n"
            ...
            "4. vercel_deploy_from_github(repo_url=<url>, root_directory='frontend') — deploy as COMPANY_NAME project. If deployed=False, continue with repo_url only.\n"
