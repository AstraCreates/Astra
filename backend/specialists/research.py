...
_FOCUS_ROLES = {
    ...
    "research_competitors": (
        ...
        "2. Call deep_research(['<topic> competitor pricing 2025', '<topic> alternatives Capterra G2 ProductHunt', "
        "'<topic> YC-backed startups funding', '<topic> competitor weaknesses reviews']) only if the first pass still has coverage gaps or deeper competitive evidence is required.\n"
