...
_FUNDRAISE_SEARCH_SEQUENCE = (
    "FUNDRAISING RESEARCH (run ALL 10 searches in order, replacing {topic} with the actual subject):\n"
    "1.  search_and_fetch('{topic} startup funding round 2024 2025 seed Series A raise amount')\n"
    "2.  search_and_fetch('{topic} SAFE note terms valuation cap discount rate standard YC 2024 2025')\n"
    "3.  search_and_fetch('{topic} venture capital investors VCs active seed Series A 2024 2025')\n"
    "4.  search_and_fetch('{topic} top angel investors active 2024 2025 site:linkedin.com OR site:angellist.com')\n"
    "5.  search_and_fetch('{topic} VC fund portfolio investments recent 2024 2025 site:crunchbase.com')\n"
    "6.  web_search('{topic} best venture capital firms investing 2025 seed pre-seed')\n"
    "7.  web_search('{topic} market size TAM SAM SOM 2024 2025 billion')\n"
    "8.  search_and_fetch('{topic} competitor funding raised investors lead 2024 2025')\n"
    "9.  search_and_fetch('YC SAFE post-money valuation cap standard terms 2024 2025')\n"
    "10. search_and_fetch('{topic} pitch deck narrative problem solution traction ask investors')\n\n"
    "Then fetch_and_read on 4+ of the most relevant VC firm pages, Crunchbase profiles, or AngelList pages "
    "to confirm active investment thesis and check sizes.\n\n"
    ...
    "B. TARGET INVESTOR LIST (10-15 investors)\n"
    "   Build a list of 10-15 VCs and angels actively investing in this space. For each include:\n"
    "   - Fund/investor name\n"
    "   - Check size range\n"
    "   - Stage focus (pre-seed / seed / Series A)\n"
    "   - Why they're a fit (portfolio companies, stated thesis, partner focus areas)\n"
    "   - Website or contact page URL\n"
    "   Find these via web_search and search_and_fetch — use real names from search results.\n\n"
    ...
    "   Use format_legal_document(doc_type='SAFE Terms Summary', company_name=<company>, content=<terms text>).\n\n"
    "E. INVESTOR ONE-PAGER PDF\n"
    "   Call generate_pdf with title='[Company] Investor One-Pager' and sections:\n"
