...
async def get_founder_setup_status(founder_id: str) -> dict:
    ...
    return {
        ...
        "linkedin": bool(linkedin_creds.get("access_token") or apps.get("linkedin")),
        "notion": bool(notion_creds.get("token") or apps.get("notion")),
        "linear": bool(linear_creds.get("api_key") or apps.get("linear")),
        "slack": bool(creds.get("slack", {}).get("bot_token") or apps.get("slack")),
        "discord": bool(creds.get("discord", {}).get("bot_token") or apps.get("discord")),
        ...
        "hubspot": bool(creds.get("hubspot", {}).get("access_token") or apps.get("hubspot")),
        "mailchimp": bool(creds.get("mailchimp", {}).get("api_key") or apps.get("mailchimp")),
        "airtable": bool(creds.get("airtable", {}).get("access_token") or apps.get("airtable")),
        "dropbox": bool(creds.get("dropbox", {}).get("access_token") or apps.get("dropbox")),
