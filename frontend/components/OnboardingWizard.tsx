...
function StepCustomStack({ selected, onToggle, onBack, onNext }: {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h2 style={{ fontSize: 22, fontWeight: 700, margin: "0 0 6px", color: T.textPrimary, fontFamily: "var(--font-geist-sans)" }}>
          Build your stack
        </h2>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
              <span style={{ fontSize: 13, fontWeight: 500, color: T.textPrimary, fontFamily: "var(--font-geist-sans)" }}>{label}</span>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px" }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ fontSize: 13, fontWeight: 500, color: T.textPrimary, fontFamily: "var(--font-geist-sans)" }}>Composio</span>
...
function StepWelcome({ name, setName, company, setCompany, goal, setGoal, onNext }: {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
      <div>
        <h1 style={{ fontSize: 28, fontWeight: 700, margin: "0 0 8px", color: T.textPrimary, fontFamily: "var(--font-geist-sans)" }}>
          Welcome to Astra
        </h1>
          ...
          return (
            <div key={stack.stack_id} style={selected ? CARD_SELECTED : CARD} onClick={() => onSelect(stack.stack_id)}>
              <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
                    <span style={{ fontSize: 13, fontWeight: 600, color: T.textPrimary, fontFamily: "var(--font-geist-sans)" }}>
                      {stack.name}
                    </span>
...
function StepDone({ name, company, stackName, onLaunch }: {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28, alignItems: "center", textAlign: "center" }}>
      ...
      <div>
        <h2 style={{ fontSize: 26, fontWeight: 700, margin: "0 0 10px", color: T.textPrimary, fontFamily: "var(--font-geist-sans)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, width: "100%", maxWidth: 420 }}>
        {[
          ...
          <div key={label} style={{
            ...
            <span style={{ fontSize: 12, fontWeight: 600, color: T.textPrimary, fontFamily: "var(--font-geist-sans)" }}>{label}</span>
