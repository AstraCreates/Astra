...
function StepCustomStack({ selected, onToggle, onBack, onNext }: {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div>
        <h2 style={{ fontSize: 24, fontWeight: 400, margin: "0 0 6px", color: T.textPrimary, fontFamily: "var(--font-fraunces), 'Fraunces', serif", letterSpacing: "-0.02em" }}>
          Build your stack
        </h2>
...
function StepWelcome({ name, setName, company, setCompany, goal, setGoal, onNext }: {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
      <div>
        <h1 style={{ fontSize: 32, fontWeight: 400, margin: "0 0 8px", color: T.textPrimary, fontFamily: "var(--font-fraunces), 'Fraunces', serif", letterSpacing: "-0.02em" }}>
          Welcome to Astra
        </h1>
...
function StepDone({ name, company, stackName, onLaunch }: {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28, alignItems: "center", textAlign: "center" }}>
      ...
      <div>
        <h2 style={{ fontSize: 28, fontWeight: 400, margin: "0 0 10px", color: T.textPrimary, fontFamily: "var(--font-fraunces), 'Fraunces', serif", letterSpacing: "-0.02em" }}>
