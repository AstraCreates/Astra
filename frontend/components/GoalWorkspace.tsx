  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      <div style={{ ...PREVIEW_CARD, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 10px" }}>
        ...
        <span style={{ fontSize: 11, color: state.status === "done" ? "#3D9E5F" : "#002EFF", fontWeight: 600 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          {commits.slice(-5).map((c, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 8, padding: "5px 10px", borderRadius: 6, background: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.07)" }}>
              <span style={{ fontFamily: "var(--font-jetbrains-mono)", fontSize: 10, color: "#002EFF" }}>{c.slice(0, 7)}</span>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
        <span style={{ fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "#002EFF", fontWeight: 600 }}>
          Deployment
        </span>
        {isPublished && (
          <span style={{
        ...
        {!isPublished && (
          <span style={{
            ...
            color: "#002EFF", background: "rgba(37,99,235,0.1)", borderRadius: 6, padding: "2px 8px",
          }}>
            Staged
          </span>
        )}
      ...
      {!isPublished && !showForm && (
        <button
          ...
          style={{
            ...
            background: "linear-gradient(135deg,#002EFF,#1f36e0)",
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={{
                ...
                background: publishing || !tokenInput.trim() ? "rgba(37,99,235,0.3)" : "linear-gradient(135deg,#002EFF,#1f36e0)",
                color: "#fff", fontSize: 12, fontWeight: 600,
              }}
            >
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10, padding: "18px 0" }}>
      <div style={{ height: 2, borderRadius: 999, background: "rgba(37,99,235,0.12)", overflow: "hidden" }}>
        <div style={{ height: "100%", borderRadius: 999, background: "linear-gradient(90deg, #002EFF, #7C3AED, #002EFF)", backgroundSize: "200% 100%", animation: "shimmer 1.8s linear infinite" }} />
      </div>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        <span style={{ width: 5, height: 5, borderRadius: "50%", background: "#002EFF", flexShrink: 0 }} className="animate-pulse" />
        <span style={{ fontSize: 11, color: "var(--fg-mute)" }}>{label}</span>
        {tool && <span style={{ fontSize: 10, color: "#002EFF", fontFamily: "var(--font-jetbrains-mono)", marginLeft: "auto", opacity: 0.8 }}>{tool.replace(/_/g, "_")}</span>}
      </div>
    ...
    <div style={{ borderRadius: 14, overflow: "hidden", border: "1px solid rgba(255,255,255,0.07)", background: "rgba(9,11,17,0.96)" }}>
      ...
      {isRunning && (
        <div style={{ height: 2, background: "rgba(0,0,0,0.4)" }}>
          <div style={{ height: "100%", background: "linear-gradient(90deg,#002EFF,#7C3AED,#4ADE80,#002EFF)", backgroundSize: "300% 100%", animation: "termShimmer 2.4s linear infinite" }} />
        </div>
      )}
      <style>{`
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        {(isDone || state.status === "error") && (
          <button
            ...
            style={{
              ...
              color: rerunning ? "#002EFF" : "var(--fg-dim)", cursor: rerunning ? "default" : "pointer",
        ...
        <div style={{ position: "relative", width: 40, height: 40, flexShrink: 0 }}>
          <svg viewBox="0 0 40 40" style={{ transform: "rotate(-90deg)" }}>
            ...
            <circle cx="20" cy="20" r="17" fill="none" stroke={isDone ? "#3D9E5F" : "#002EFF"} strokeWidth="3"
      ...
      {agentList.map(name => {
        ...
        return (
          <button key={name} onClick={() => onSelect(name)} style={{
            ...
            minHeight: 52,
            borderRadius: 14,
            border: `1px solid ${isActive ? "#002EFF" : isRunning ? "rgba(37,99,235,0.35)" : "var(--line)"}`,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <span style={{
                ...
                background: status === "done" ? "#22C55E" : status === "running" ? "#002EFF" : status === "error" ? "#EF4444" : "rgba(255,255,255,0.15)",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4, paddingLeft: 19, minHeight: 13 }}>
              {modelShort ? (
                <span style={{ fontSize: 9, color: "#002EFF", whiteSpace: "nowrap", fontFamily: "var(--font-jetbrains-mono)", opacity: 0.8 }}>
                  {modelShort}
                </span>
...
function AgentQuestionCard({ sessionId, question, onDone }: {
  ...
  const tone = question.severity === "critical"
    ? { badgeBg: "rgba(220,38,38,0.12)", badgeBorder: "rgba(220,38,38,0.24)", badgeColor: "#dc2626" }
    : question.severity === "warning"
      ? { badgeBg: "rgba(217,119,6,0.12)", badgeBorder: "rgba(217,119,6,0.22)", badgeColor: "#d97706" }
      : { badgeBg: "rgba(0,46,255,0.08)", badgeBorder: "rgba(0,46,255,0.16)", badgeColor: "var(--blue)" };

  return (
    <div className="astra-modal-backdrop" style={{ zIndex: 9000 }}>
      <div className="astra-modal-shell" style={{ maxWidth: 640 }}>
        <div className="astra-modal-panel">
          <div className="astra-modal-header">
            <div className="astra-modal-header-row">
              <div>
                <div className="astra-modal-eyebrow" style={{ background: tone.badgeBg, borderColor: tone.badgeBorder, color: tone.badgeColor }}>
                  founder decision
                </div>
                <h2 className="astra-modal-title" style={{ fontSize: 24 }}>{question.title || "Astra needs your input"}</h2>
                <p className="astra-modal-sub" style={{ maxWidth: 520 }}>{question.question}</p>
              </div>
              <button onClick={onDone} className="astra-modal-close" aria-label="Dismiss question">×</button>
            </div>
          </div>
          <div className="astra-modal-body">
          {question.context && (
            <div className="astra-modal-card" style={{ padding: 16 }}>
              <div style={{ fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--fm)", marginBottom: 8, fontWeight: 700 }}>
                Why This Matters
              </div>
              <div style={{ fontSize: 13, lineHeight: 1.65, color: "var(--fd)" }}>{question.context}</div>
            </div>
          )}
          {question.recommendation && (
            <div style={{
              ...
              <div style={{ fontSize: 10.5, letterSpacing: "0.08em", textTransform: "uppercase", fontWeight: 700, color: tone.badgeColor, marginBottom: 6 }}>
                Recommended
              </div>
              <div style={{ fontSize: 13, lineHeight: 1.6 }}>{question.recommendation}</div>
            </div>
          )}
          {question.options.length > 0 ? (
            <div className="astra-choice-grid">
              {question.options.map((opt) => (
                <button
                  ...
                  onClick={() => submit(opt)}
                  disabled={submitting}
                  className="astra-choice-card"
                  style={{ display: "flex", flexDirection: "column", gap: 6 }}
                >
                  <span style={{ fontSize: 13.5, fontWeight: 600, color: "var(--fg)" }}>{opt}</span>
                  {question.option_details?.[opt] && (
                    <span style={{ fontSize: 11.5, color: "var(--fd)", lineHeight: 1.5 }}>{question.option_details[opt]}</span>
                  )}
                </button>
              ))}
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div className="astra-modal-actions">
                <button onClick={onDone} className="btn">Later</button>
                <button
                  onClick={() => submit()}
                  disabled={submitting || !answer.trim()}
                  className="btn pri"
                  style={{ minWidth: 120, opacity: !answer.trim() ? 0.5 : 1 }}
                >
...
// LLC Filing Modal moved to its own shared file (./LLCFilingModal) so
// PhaseWorkboard.tsx can reuse it instead of drifting into its own copy.
    ...
    <div style={{ display: "grid", gap: 10 }}>
      ...
      <div className="site-card-soft" style={{ overflow: "hidden", background: "rgba(255,255,255,0.06)" }}>
        {rows.slice(0, 12).map((row, i) => {
          ...
          const statusColor = isDone ? "#10B981" : isBlocked ? "#D97706" : isRunning ? "#002EFF" : "var(--text-muted)";
                        ...
                        <button key={item.id} className="astra-checklist-item" onClick={() => !isAuto && toggle(item.id, checked)} style={{
                          ...
                          <span style={{ display: "flex", flexDirection: "column", gap: 1, minWidth: 0 }}>
                            <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                              ...
                              {isAuto && <span style={{ fontSize: 9, color: "#002EFF", flexShrink: 0 }}>auto</span>}
                            </span>
...
function SessionHistory({ currentSessionId }: { currentSessionId: string }) {
  ...
  const statusDot = (s: SessionRecord["status"]) =>
    s === "done" ? "#3D9E5F" : s === "running" ? "#002EFF" : "#C0392B";
  ...
  const handleSessionEvent = useCallback((event: SessionEvent) => {
      ...
      if (event.type === "agent_question") {
        setAgentQuestion({
          ...
          option_details: event.option_details ?? {},
        });
        return;
      }
        ...
        {companyGoal && (
          <div style={{ borderRadius: 10, border: "1px solid rgba(37,99,235,0.18)", background: "rgba(37,99,235,0.07)", padding: "12px 14px", display: "flex", flexDirection: "column", gap: 6 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
              <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#002EFF" }}>Operating</span>
                ...
                <div style={{ display: "grid", gap: 9, borderTop: "1px solid rgba(176,180,186,0.10)", paddingTop: 12 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(112px, 1fr))", gap: 7 }}>
                    {(laneAudit.length ? laneAudit : agentList.map(agent => ({ agent, status: visibleAgents[agent]?.status, ok: visibleAgents[agent]?.status === "done" }))).slice(0, 12).map((lane, index) => {
                      ...
                      const color = ok ? "#3D9E5F" : laneStatus === "running" ? "#002EFF" : "#C0392B";
                      return (
                        <button
                          key={`${agent}-${index}`}
                          type="button"
