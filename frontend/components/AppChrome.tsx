      ...
      <div style={{ display: "flex", flexDirection: "column", minHeight: "100dvh", background: "transparent", position: "relative", zIndex: 2 }}>
        ...
        {isHome ? (
          ...
          <main style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
            <div style={{ height: 46, display: "flex", alignItems: "center", padding: "0 14px", borderBottom: "1px solid rgba(255,255,255,0.4)", background: "var(--surface)", backdropFilter: "blur(28px) saturate(1.3)", WebkitBackdropFilter: "blur(28px) saturate(1.3)", flexShrink: 0 }}>
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "transparent", position: "relative", zIndex: 2 }}>
      ...
      {isHome ? (
        ...
        <main style={{ flex: 1, minWidth: 0, height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
          <div style={{ height: 44, display: "flex", alignItems: "center", padding: "0 18px", borderBottom: "1px solid rgba(255,255,255,0.4)", background: "var(--surface)", backdropFilter: "blur(28px) saturate(1.3)", WebkitBackdropFilter: "blur(28px) saturate(1.3)", flexShrink: 0 }}>
            <div className="topbar-title">{title || "Astra"}</div>
          </div>
