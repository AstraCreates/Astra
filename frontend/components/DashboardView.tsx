  ...
  return (
    <>
      <style>{`
        ...
        .sc-row { cursor: pointer; padding: 14px 16px; border: 1px solid rgba(255,255,255,0.65); background: rgba(255,255,255,0.18); display: flex; align-items: flex-start; gap: 14; transition: border-color .15s, box-shadow .15s; position: relative; overflow: hidden; backdrop-filter: blur(20px) brightness(0.75) saturate(1.3); -webkit-backdrop-filter: blur(20px) brightness(0.75) saturate(1.3); box-shadow: inset 0 1.5px 0 rgba(255,255,255,0.85), 0 4px 16px rgba(0,0,0,0.06); }
