  ...
  return (
    <>
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
        ...
        {/* ── Custom agent runs — separate from regular goal sessions ── */}
        <div style={{ padding: "20px 24px 0" }}>
          ...
          {customSessions.length === 0 ? (
            <div style={{ fontSize: 11, color: "var(--fm)", padding: "2px 0 16px" }}>
        ...
        <div className="dv-content" style={{ padding: "0 24px 40px", display: "flex", gap: 24, alignItems: "flex-start" }}>
