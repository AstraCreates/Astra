  ...
  return (
    <>
      <style>{`
        ...
        .sc-row { cursor: pointer; padding: 14px 16px; border: 1px solid rgba(255,255,255,0.8); background: rgba(255,255,255,0.68); display: flex; align-items: flex-start; gap: 14; transition: border-color .15s, box-shadow .15s; position: relative; overflow: hidden; backdrop-filter: blur(20px) saturate(1.5); -webkit-backdrop-filter: blur(20px) saturate(1.5); box-shadow: 0 1px 8px rgba(0,0,0,0.05), inset 0 1px 0 rgba(255,255,255,0.9); }
