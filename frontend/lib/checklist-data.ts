...
export const CHECKLIST_CATEGORIES: CLCategory[] = [
  {
    ...
    items: [
      ...
      { id: "pricing_willingness", label: "Test willingness-to-pay", autoAgent: "research", detail: "Van Westendorp or direct pre-sale to confirm price points." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "incident_plan",     label: "Write a security incident response plan", autoAgent: "ops" },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "product_hunt",      label: "Create Product Hunt launch page", autoAgent: "marketing", detail: "Line up hunters and supporters a week ahead." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "billing_tax",       label: "Configure sales tax / VAT collection", autoAgent: "finance_model", detail: "Stripe Tax or Anrok handles multi-jurisdiction automatically." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "activation_metric", label: "Define your activation ('aha') event", autoAgent: "research", detail: "The action correlated with users who stick around." },
      ...
      { id: "metrics_dashboard", label: "Create weekly metrics dashboard", autoAgent: "research_market" },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "feedback_loop",     label: "Create a customer feedback channel", autoAgent: "marketing", detail: "Make it trivial for users to tell you what's broken." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "investor_list",     label: "Build target investor list (CRM)", autoAgent: "research" },
