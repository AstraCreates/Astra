...
import { Geist, Geist_Mono, DM_Sans, IBM_Plex_Mono, JetBrains_Mono, Pixelify_Sans, Instrument_Sans, Hanken_Grotesk } from "next/font/google";
...
const hankenGrotesk = Hanken_Grotesk({ subsets: ["latin"], weight: ["400", "500", "600", "700", "800"], variable: "--font-hanken" });
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${geist.variable} ${geistMono.variable} ${dmSans.variable} ${ibmPlexMono.variable} ${jetbrainsMono.variable} ${pixelifySans.variable} ${instrumentSans.variable} ${hankenGrotesk.variable} antialiased`} data-theme="dark" suppressHydrationWarning>
